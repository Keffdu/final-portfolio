...
If you would like to run this app locally you can clone this repo and cd into ```cd Front\ End\ Project``` which will take you to the root. from there run ```npm i``` to install
