...
- Through using MUI as well as CSS Flex, I build our application to be responsive regardless of the browser size or device.
- This allows more users to interact with the application as well as leads to an overall better UX.
- the use of Flex and its properties ```flexWrap``` allows for the overflow within the FavortiesList component
