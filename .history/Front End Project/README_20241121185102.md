...
- Through utilizing standardized libraries such as [Material UI](https://mui.com/material-ui/) I was able to build a more uniform and intuitive layout for the user which in turn allows 
![SS4](./assets/SS4.png)
