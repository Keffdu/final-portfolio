...
Then with only 4 favorites you can see how that second row behaves. since we have flew wrap and we also set ```justifyContent``` to space-evenly that is causing 
