...
Our main focus for this project was to integrate an external API and build a UI around it that is intuitive to use and provides accessibility features. 
