...
- I have fully adopted the use of Git for version control. I know the best practices for cloning and working in a repo.  I have learning how to create feature branches and open a pull request. Within this project specifically and all other projects, GitHub has been used, and all work that i have done was 
