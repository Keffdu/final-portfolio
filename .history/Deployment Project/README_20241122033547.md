...
for this project from brainstorming the idea, initializing the project, then developing, creating the CI/CD pipeline and with GitHub Actions and Docker - all of these make up the software development life cycle and allowed 
