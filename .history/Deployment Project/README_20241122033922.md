...
This project required a lot of new learning for me especially when it came to Docker and Backstage. Luckily they both have very helpful documentation with technical guides and tutorials. Through those pages, i was able to follow software designs and technical specifications to correclty configure and set up both the Docker file in the project as well as configurations within
