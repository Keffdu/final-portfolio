...
after making a fetch request to the API, the response is checked for a status code, and acted upon accordingly. This allows us to better manage our data and to 
